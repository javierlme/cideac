module.exports = {
  ...
  categories: [
    { name: 'Ceuta FPB',   code: 'FPB', city: 'Ceuta',   type: 'FPB' },
    ...
    { name: 'Ceuta CE',    code: 'CE',  city: 'Ceuta',   type: 'CE'  },
    { name: 'Melilla FPB', code: 'FPB', city: 'Melilla', type: 'FPB' },
